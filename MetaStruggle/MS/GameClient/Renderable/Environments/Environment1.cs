...
namespace GameClient.Renderable.Environments
{
    public static class Environment1
    {
        public static SceneManager GetScene(SpriteBatch spriteBatch)
        {
            ...
            sm.Skybox = new Skybox(Global.RessourceProvider.Skyboxes["grisaille"]);
            ...
            sm.AddElement(new Model3D(sm, Global.RessourceProvider.StaticModels["MapMinecraft"], new Vector3(10, 0, 0),
